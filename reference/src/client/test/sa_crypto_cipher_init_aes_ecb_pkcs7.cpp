...
namespace {
    TEST_F(SaCryptoCipherWithoutSvpTest, initAesEcbPkcs7FailsInvalidKeySize48) {
        ...
        sa_status const status = sa_crypto_cipher_init(cipher.get(), SA_CIPHER_ALGORITHM_AES_ECB_PKCS7,
    ...
    TEST_F(SaCryptoCipherWithoutSvpTest, initAesEcbPkcs7FailsInvalidKeyType) {
