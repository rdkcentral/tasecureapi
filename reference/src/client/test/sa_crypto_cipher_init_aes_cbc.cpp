...
namespace {
    TEST_F(SaCryptoCipherWithoutSvpTest, initAesCbcFailsBadKeySize48) {
    ...
    TEST_F(SaCryptoCipherWithoutSvpTest, initAesCbcFailsBadKeyType) {
    ...
    TEST_F(SaCryptoCipherWithoutSvpTest, initAesCbcFailsBadIvLength) {
        auto clear_key = random(SYM_128_KEY_SIZE);
