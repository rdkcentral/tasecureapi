...
DECLARE_CIPHER(aes, 128, gcm, EVP_CIPH_GCM_MODE | EVP_CIPH_ALWAYS_CALL_INIT | EVP_CIPH_CUSTOM_IV |
    EVP_CIPH_FLAG_CUSTOM_CIPHER)
DECLARE_CIPHER(aes, 256, gcm, EVP_CIPH_GCM_MODE | EVP_CIPH_ALWAYS_CALL_INIT | EVP_CIPH_CUSTOM_IV |
    EVP_CIPH_FLAG_CUSTOM_CIPHER)
#if OPENSSL_VERSION_NUMBER >= 0x10100000
