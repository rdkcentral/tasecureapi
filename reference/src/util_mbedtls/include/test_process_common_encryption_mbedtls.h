...
#ifndef TEST_PROCESS_COMMON_ENCRYPTION_MBEDTLS_H
#define TEST_PROCESS_COMMON_ENCRYPTION_MBEDTLS_H
...
class ProcessCommonEncryptionMbedtls {
protected:
    bool build_samples(
            size_t sample_size,
    ...
    ~ProcessCommonEncryptionMbedtls() = default;

private:
    static mbedtls_cipher_context_t* mbedtls_init(
            const void* iv,
            const uint8_t* key,
            sa_cipher_algorithm cipher_algorithm);
...
#endif // TEST_PROCESS_COMMON_ENCRYPTION_MBEDTLS_H
